var path = 'regratrabalhos/';

app.regraTrabalho = {
	init : function() {
		app.regraTrabalho.prepareForm();
		app.regraTrabalho.prepareCancelButton();
		app.regraTrabalho.verifyEditing();
	...
	prepareCancelButton : function() {
		$('#backButton').click(app.regraTrabalho.back);
	},

	back : function() {
		window.location.replace('regras_trabalho.jsp');
	},
...
$(document).ready(app.regraTrabalho.init);