...
<div class="page-header">
	<h1 class="text-center">Listagem de Regras de Trabalho</h1>

	<ol class="breadcrumb">
		<li><a href="index.jsp">Home</a></li>
		<li class="active">Regras de Trabalho</li>
	</ol>
</div>
...
<div class="container">
	<div
		...
		<div class="col-sm-12 text-right"
			...
			<a href="novo_regra_trabalho.jsp"
...
<script src="../assets/js/regras_trabalho.js"></script>
...
<script id="data-table" type="text/x-handlebars-template">
		...
		{{#each list}}
			<tr>
				...
				<td class="options">
					<a href="novo_regra_trabalho.jsp?e={{id}}" class="btn btn-warning btn-sm" title="Alterar">
