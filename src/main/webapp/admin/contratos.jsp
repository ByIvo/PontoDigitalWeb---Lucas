...
<div class="page-header">
	<h1 class="text-center">Listagem de Contratos</h1>
...
<script id="data-table" type="text/x-handlebars-template">
 				<tr>
					...
					<th class="salario">Salário</th>
					<th class="dataContrato">Data de Contrato</th>
					<th class="funcionario">Funcionario</th>
		...
		{{#each list}}
			<tr>
				...
				<td class="dataContrato">{{dataContrato}}</td>
				<td class="funcionario">{{funcionario.nome}}</td>
				<td class="options">
					<a href="novo_contrato.jsp?e={{id}}" class="btn btn-warning btn-sm" title="Alterar">
						<span class="glyphicon glyphicon-edit"></span>
					</a>

					<button onclick="app.contrato.confirmDeletation({{id}});" class="btn btn-danger btn-sm" title="Remover">
